...
The Fxemoji and Noto Emoji SVGs are used under the
[Apache License, Version 2.0](https://www.apache.org/licenses/LICENSE-2.0).
Copyright © Mozilla Foundation (Fxemoji) and Google LLC (Noto Emojis).
No modifications have been made to the original files.

### MIT License notice

The Twemoji SVG (`t-rex.svg`) is used under the
[MIT License](https://opensource.org/licenses/MIT).
Copyright © Twitter, Inc.

### CC0

`lobster.svg` and `dolphin.svg` are released under CC0 (public domain).
